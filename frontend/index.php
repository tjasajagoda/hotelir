      ...
      <div class="row">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Izberite vrsto storitve</h3>
          </div>
          <div id="seznamStoritev">
          ...
          <!-- <div class="box-body" style="cursor: pointer;" onclick="location.href='storitve.html';">
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Prevoz</span>
                </div>
              </div>
            </div>
