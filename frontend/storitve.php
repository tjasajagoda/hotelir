...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
          <div class="row" id="seznamStoritev">
            <!-- <div class="col-sm-4 col-md-3">
              <div class="thumbnail">
                <img src="dist/img/pancakes.jpg" style="height:200px!important;" >
                <div class="caption">
                  <h3>Ameriške palačinke </h3>
                  <p>z gozdnimi sadeži</p>
                  <p>Cena: <b>7€</b></p>
                  <p><a href="#" class="btn btn-primary" role="button">Dodaj v košarico</a> <a href="#" class="btn btn-default" role="button">Podrobnosti</a></p>
                </div>
              </div>
            </div>
            <div class="col-sm-4 col-md-3">
            ...
            <!-- <div class="col-sm-4 col-md-3">
              <div class="thumbnail" value="3">
                <img src="dist/img/cheesecake.jpg" style="height:200px!important;">
                <div class="caption">
                  <h3 >Cheesecake </h3>
                  <p>z gozdnimi sadeži</p>
                  <p>Cena: <b>5€</b></p>
                  <p><a href="#" value="3" onclick="addItem(3)" class="btn btn-primary" role="button">Dodaj v košarico</a> <a href="#" class="btn btn-default" role="button">Podrobnosti</a></p>
                </div>
              </div>
            </div> -->
          </div>
